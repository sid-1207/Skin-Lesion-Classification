# -*- coding: utf-8 -*-
"""ML_Project_InceptionResNet_200epochs.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1npHhvXmuesq94ouAb9Pa-1gMVnLCi1xW
"""
...
def load_data():
    ...
    for folder in os.listdir(train_dir):
        ...
        for image in os.listdir(train_dir + "/" + folder):
            ...
            if new_image[labels_dict[folder]]>total_image[labels_dict[folder]] and total_image[labels_dict[folder]] < (len(os.listdir(train_dir + "/" + folder))/1.25):
...
model = load_model('/content/drive/My Drive/ML/mlproject/model_vaish/complete_trained_model_150epoc.model')
...
model.save('/content/drive/My Drive/ML/mlproject/model_vaish/complete_trained_model_200epoc.h5')
model.save('/content/drive/My Drive/ML/mlproject/model_vaish/complete_trained_model_200epoc.model')

with open('/content/drive/My Drive/ML/mlproject/images_processed_vaish.txt', 'w') as f:
    np.savetxt(f, total_image)

test_dir = "/content/drive/My Drive/ML/mlproject/test"

from keras.models import load_model

model = load_model('/content/drive/My Drive/ML/mlproject/model_vaish/complete_trained_model_200epoc.model')
